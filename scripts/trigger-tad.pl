...
This program is intended to be run once a month during an annual Perl development cycle.  Each time it runs:
...
=item *
  ...
  perl /home/jkeenan/bin/perl/trigger-tad.pl \
    ...
    --minor_version=29 \
    --compression=gz \
    --river_file=/home/jkeenan/var/tad/src/modules.XXXXXXXX.cpan.river.txt \
    --title=cpan-river-3000 \
    --email_to='"James E Keenan" <jkeenan@pobox.com>' \
    --email_from='"Jim Keenan Linode" <jkeenan@thenceforward.net>' \
